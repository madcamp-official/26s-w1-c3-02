...
WIKIPEDIA_ONTHISDAY_BASE_URL = env('WIKIPEDIA_ONTHISDAY_BASE_URL', 'https://en.wikipedia.org/api/rest_v1/feed/onthisday')
WIKIPEDIA_USER_AGENT = env('WIKIPEDIA_USER_AGENT', 'MunjangSeojae-DailyCuration/1.0 (madcamp student project)')
WIKIPEDIA_REQUEST_TIMEOUT = env_int('WIKIPEDIA_REQUEST_TIMEOUT', 10)
DAILY_CURATION_BATCH_SIZE = env_int('DAILY_CURATION_BATCH_SIZE', 5)
