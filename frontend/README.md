...
:root {
  --bg: #F9F8F6;          /* 전체 배경: 소프트 크림 */
  --surface: #FFFFFF;     /* 카드/헤더 */
  --surface-soft: #F4F3F1;/* 섹션 배경 */
  --border: #E0DAD3;      /* 연한 베이지-그레이 경계선 */

  --primary: #172035;     /* 메인 네이비 */
  --primary-2: #253048;   /* 버튼/활성 네이비 */
  --text: #1F2937;        /* 본문 텍스트 */
  --muted: #7E867D;       /* 보조 텍스트 */

  --tag-bg: #EEF3F8;      /* 태그 배경 */
  --tag-text: #48607A;    /* 태그 텍스트 */
  --shadow: rgba(23, 32, 53, 0.08);
}
